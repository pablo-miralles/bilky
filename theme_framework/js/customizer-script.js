...
(function($) {
	...
	api.bind('pane-contents-reflowed', function() {
		...
		api.section.each(function(section) {
			if (
				'mwm_custom_section' !== section.params.type ||
		...
		api.panel.each(function(panel) {
			if (
				'mwm_custom_panel' !== panel.params.type ||
	...
	wp.customize.Panel = wp.customize.Panel.extend({
		attachEvents: function() {
			if (
				'mwm_custom_panel' !== this.params.type ||
		...
		isContextuallyActive: function() {
			if ('mwm_custom_panel' !== this.params.type) {
	...
	wp.customize.Section = wp.customize.Section.extend({
		attachEvents: function() {
			if (
				'mwm_custom_section' !== this.params.type ||
		...
		isContextuallyActive: function() {
			if ('mwm_custom_section' !== this.params.type) {
